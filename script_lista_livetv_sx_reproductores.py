...
# Función para obtener una sesión con reintentos
def get_session():
...
# Función mejorada para extraer links de reproductores
def extract_reproductor_links(html_content, url_base):
    soup = BeautifulSoup(html_content, 'lxml')
    reproductores = []
    
    # Método 1: Buscar por XPath específico (convertido a selectores CSS)
    ...
    if specific_element:
        logger.info("Elemento encontrado con XPath específico")
    ...
    # Método 2: Buscar contenedores de reproductores específicos
    ...
    # Método 3: Buscar enlaces con patrones específicos de reproductores
    ...
    # Método 4: Buscar iframes que pueden ser reproductores embebidos
    ...
    # Método 5: Buscar scripts que puedan contener URLs de reproductores
...
# Función para hacer scraping de cada URL
...
# Función para crear el XML con los reproductores
...
def main():
    ...
    logger.info("Iniciando actualización de enlaces de streaming")
